...
**_NOTE3: After the first iteration has been completed, this repo will be open for push requests. If you see something that should be improved, please do so._**
