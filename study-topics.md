...
- "_Sandworm_" by Andy Greenberg is highly recommended. Both for the content itself but also as a break from highly technical/regulatory/process-oriented reading. The book provides a very interesting overview of cyber warfare, and frames the more in-depth resources of this reference manual in a clear context; for example: why is ICS security so important, and why are certain control and processes highlighted.
